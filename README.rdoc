...
- copy the post-receive script and commit_notifier_config.yml into the /hooks directory of your repository on the Git server
- set your preferred delivery method in commit_notifier_config.yml, set SMTP server options if you choose this delivery method
- make sure your 'post_receive' script is executable


See your_repository/hooks/commit_notifier_config.yml for setting your SMTP server address.
