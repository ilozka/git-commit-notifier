...
- copy the post_receive script and the git_commit_notifier directory
  into the /project/.git/hooks directory of your Git server
- make sure the following Git settings are correct:
    ...
    (see config/config.yml for overridding these Git settings)
